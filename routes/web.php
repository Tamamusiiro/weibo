...
Route::get('confirm_email/{token}', 'UserController@confirmEmail')->name('confirm_email');
...
Route::post('user/follow_toggle/{user}', 'UserController@followToggle')->name('user.follow_toggle');
